...
pub trait SpvBitAndAssign<Rhs: AsPrimitiveType + AsPrimitive>: AsPrimitiveType + AsPrimitive { }
pub trait SpvBitOrAssign<Rhs: AsPrimitiveType + AsPrimitive>: AsPrimitiveType + AsPrimitive {}
pub trait SpvBitXorAssign<Rhs: AsPrimitiveType + AsPrimitive>: AsPrimitiveType + AsPrimitive { }
...
impl_scalar_ty_ops!(
    Int, i32, IVec2, GlamIVec2,
    Int, i32, IVec3, GlamIVec3,
    Int, i32, IVec4, GlamIVec4,
    UInt, u32, UVec2, GlamUVec2,
    UInt, u32, UVec3, GlamUVec3,
    UInt, u32, UVec4, GlamUVec4,
    Float, f32, Vec2, GlamVec2,
    Float, f32, Vec3, GlamVec3,
    Float, f32, Vec4, GlamVec4,
    Float, f32, Mat2, GlamMat2,
    Float, f32, Mat3, GlamMat3,
    Float, f32, Mat4, GlamMat4,
    Double, f64, DVec2, GlamDVec2,
    Double, f64, DVec3, GlamDVec3,
    Double, f64, DVec4, GlamDVec4,
    Double, f64, DMat2, GlamDMat2,
    Double, f64, DMat3, GlamDMat3,
    Double, f64, DMat4, GlamDMat4,
);
